...
class Fighter: Spaceship {
    ...
    func fire () {
        if remainingFirePower > 0 {
            ...
            print("you don't have an remaining fire power")
        }
    }
}
...
print("we can't print weapon on falcon beacuse it is not inhearting Fighter so it does'nt have weapon property")
